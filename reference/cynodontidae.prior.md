...
analysis of the family Cynodontidae using Beast2. From an original
sample of 20000, these include the last 1000 samples and only preserve
the columns with node ages.
...
A data frame named cynodontidae.prior with six columns:
